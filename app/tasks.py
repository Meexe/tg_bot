...
tasks = [
    ...
    Task(
	    [
            {
             	'type': 'text',
                'payload': 'А тем временем нам пора в Гнездинский переулок',
                'delay': 2,
            },
            {
             	'type': 'text',
                'payload': '1. Ну кароч этот переулок крут', # TODO вставить описание переулка
                'delay': 30,
            },
            {
             	'type': 'text',
            ...
            {
             	'type': 'text',
                'payload': 'Местные утверждают, что где-то здесь водится очень редкая и гордая птица.' \
    ...
    Task(
	    [
	        {
           	    'type': 'text',
                'payload':	'Посмотрите по сторонам: при входе висит большая золотая схема' \
    ...
    Task(
        ...
        [
            {
                'type': 'text',
                'payload': 'Поблагодарим автора этой замечательной загадки, и тут же пойдем дальше',
                'delay': 2,
            }
        ],
    ),
    ...
    Task(
	    [  
            {
             	'type': 'text',
                'payload': 'Присаживайтесь поудобнее на какую-нибудь лавочку, и осторожнее, кто-то опять пролил масло!',
                'delay': 4,
            },
	        {
             	'type': 'text',
    ...
    Task(
	    ...
	    [
	        ...
	        {
             	'type': 'text', # или голосовуха всей группы с местом кафешки
